...
export default function ChildSignUpScreen({ navigation }) {
    ...
    const onSignup = async () => {
        try {
            ...
            formdata.append('children', JSON.stringify(payload));
            const url = 'Children/addChild';
        ...
        <View style={{ flex: 1, marginTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0, backgroundColor: Colors.backgroundColor, }}>
            ...
            <KeyboardAvoidingView
                ...
                <ScrollView
                    ...
                    <View style={{ marginTop: 15, justifyContent: 'center', alignItems: 'center', gap: 15 }}>
                        <TextInput style={{
                            borderWidth: 2,
                            borderRadius: 10,
                            borderColor: Colors.border,
